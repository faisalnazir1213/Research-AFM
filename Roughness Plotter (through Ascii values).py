# Rename ASCII files to ascending order (something like 1_untreated)in order to have proper lableing in legend
...
plt.savefig('high_resolution_plot.png', dpi=600, facecolor='w', edgecolor='w',
